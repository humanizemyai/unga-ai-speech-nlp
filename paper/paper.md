...
Pooled, the rate is **6.08 per 10,000 words in 2015-2022 and 12.19 in 2024-2025**. The lower bound of the 2025 interval (10.25) sits above the upper bound of every pre-ChatGPT year (highest: 8.72 in 2016). Nearly one statement in three used *unwavering* in 2024, against about one in ten in every year from 2015 to 2022.
